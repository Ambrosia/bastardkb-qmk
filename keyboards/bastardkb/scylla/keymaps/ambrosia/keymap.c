...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_split_4x6_5(
        ...
        //-------------------------------------------------//-----------------------------------------------------------//
        MO(_GAMING_NUM), KC_SPC, KC_ESC, KC_DEL, KC_BSPC, MO(_SYS),
        //-------------------------------------------------//-----------------------------------------------------------//
        KC_LSFT, KC_TAB, KC_ENT, KC_LSFT),

    [_GAMING_NUM] = LAYOUT_split_4x6_5(
        //-------------------------------------------------//-----------------------------------------------------------//
        ...
        //-------------------------------------------------//-----------------------------------------------------------//
        _______, KC_F11, KC_F12, KC_PGDN, KC_PGUP, _______, _______, _______, _______, _______, _______, _______,
        //-------------------------------------------------//-----------------------------------------------------------//
        _______, _______, _______, _______, _______, _______,
        //-------------------------------------------------//-----------------------------------------------------------//
        _______, _______, _______, _______),
